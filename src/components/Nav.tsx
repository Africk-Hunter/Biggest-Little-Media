...
export default function Nav({ page, go, menuOpen, toggleMenu }: Props) {
  return (
    <header className="nav">
      <div className="nav-inner">
        {/* Logo */}
        <button className="nav-logo" onClick={() => go('home')}>
          <span className="nav-logo-oswald">BIGGEST</span>
          <span className="nav-logo-script">little</span>
          <span className="nav-logo-oswald">MEDIA</span>
        </button>
